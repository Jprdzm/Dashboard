      ...
      <form onSubmit={handleSubmit} className="space-y-2 mb-4">
        <div className="flex gap-2">
          ...
          <select
            ...
            className="w-1/2 px-3 py-1.5 text-sm rounded-lg border border-border-light dark:border-border-dark bg-bg-light dark:bg-bg-dark text-text-light dark:text-text-dark focus:outline-none focus:ring-2 focus:ring-neutral-500/40 transition-colors duration-200"
          >
        ...
        <div className="flex gap-2">
          ...
          <button
            type="submit"
            className="px-3 py-1.5 text-sm font-medium rounded-lg bg-neutral-900 hover:bg-neutral-800 dark:bg-neutral-100 dark:hover:bg-neutral-200 text-white dark:text-neutral-900 transition-colors duration-200 flex items-center gap-1"
          >
            <Plus size={16} />
          </button>
        </div>
