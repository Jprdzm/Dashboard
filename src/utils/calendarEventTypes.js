...
export const EVENT_TYPES = [
  ...
  { value: 'clase', label: 'Clase', dot: 'bg-indigo-500', text: 'text-indigo-600 dark:text-indigo-400', chip: 'bg-indigo-500/12 text-indigo-700 dark:text-indigo-300 dark:bg-indigo-500/15' },
