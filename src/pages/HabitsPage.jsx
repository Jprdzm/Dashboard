  ...
  return (
    <div className="min-h-screen bg-bg-light dark:bg-bg-dark text-text-light dark:text-text-dark">
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        <Link
          to="/"
          className="inline-flex items-center gap-1.5 text-sm font-medium text-textMuted-light dark:text-textMuted-dark hover:text-text-light dark:hover:text-text-dark transition-colors duration-200 ease-soft-out mb-6"
        >
          <ArrowLeft size={16} />
          Volver al Dashboard
        </Link>
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-text-light dark:text-text-dark flex items-center gap-3">
              <Target size={28} className="text-primary-light dark:text-primary-dark" />
              Hábitos
            </h1>
            {syncing && (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 mb-8">
          <div className="p-4 rounded-2xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark dark:backdrop-blur-md text-center shadow-soft-sm dark:shadow-soft-dark-sm hover:shadow-soft-md dark:hover:shadow-soft-dark-md transition-shadow duration-300 ease-soft-out">
            <BarChart3 size={16} className="mx-auto mb-1.5 text-primary-light dark:text-primary-dark" />
        ...
        {/* ════════════════════════════════════════
            DETALLE SEMANAL
           ════════════════════════════════════════ */}
        <div className="p-5 rounded-2xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark dark:backdrop-blur-md shadow-soft-sm dark:shadow-soft-dark-sm hover:shadow-soft-md dark:hover:shadow-soft-dark-md transition-shadow duration-300 ease-soft-out mb-6">
          <div className="flex items-center gap-2 mb-4">
            <CalendarDays size={16} className="text-primary-light dark:text-primary-dark" />
        ...
        {/* ════════════════════════════════════════
           ...
           ════════════════════════════════════════ */}
        {habits.length === 0 ? (
          <div className="p-12 rounded-2xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark dark:backdrop-blur-md text-center shadow-soft-sm dark:shadow-soft-dark-sm">
          ...
          <div className="overflow-x-auto rounded-2xl border border-border-light dark:border-border-dark shadow-soft-sm dark:shadow-soft-dark-sm hover:shadow-soft-md dark:hover:shadow-soft-dark-md transition-shadow duration-300 ease-soft-out">
                      ...
                      <td className="py-2.5 pl-4 pr-3">
                        {isEditing ? (
                          <div className="flex items-center gap-1">
                            ...
                            <button onClick={() => setEditingId(null)} aria-label="Cancelar edición" className="p-1 rounded text-textMuted-light dark:text-textMuted-dark hover:bg-slate-100 dark:hover:bg-white/[0.06] active:scale-90 transition-all duration-150 ease-soft-out">
                              <X size={13} />
                            </button>
                          </div>
                        ) : (
                            ...
                            >
                              <div className="flex justify-center">
                                <Checkbox
                                  ...
                                  className={`p-2.5 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/20 active:scale-90 transition-transform duration-150 ease-soft-out ${!isToday && !checked ? 'opacity-30' : ''}`}
                                />
                              </div>
                            </td>
                          );
                      ...
                      <td className="py-2.5 pr-3 pl-2 sticky right-0 bg-bg-light dark:bg-bg-dark border-l border-border-light/50 dark:border-border-dark/50 shadow-[-4px_0_6px_-1px_rgba(0,0,0,0.05)] z-10 group-hover:bg-bg-light/80 dark:group-hover:bg-bg-dark/80 transition-colors">
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded text-rose-500 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 active:scale-90 transition-all duration-150 ease-soft-out bg-rose-50/30 dark:bg-rose-900/10 border border-rose-100 dark:border-rose-900/30"
                            title="Eliminar"
                          >
                            <Trash2 size={14} />
                          </button>
        ...
        {view === 'month' && habits.length > 0 && (
          <div className="flex items-center justify-center gap-4 mt-4">
            <button
              ...
              className="text-xs font-medium text-textMuted-light dark:text-textMuted-dark hover:text-text-light dark:hover:text-text-dark transition-colors duration-200 ease-soft-out"
            >
        ...
        {/* ════════════════════════════════════════
           ...
           ════════════════════════════════════════ */}
        {view === 'month' && habits.length > 0 && (
          <div className="mt-8 p-5 rounded-2xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark dark:backdrop-blur-md shadow-soft-sm dark:shadow-soft-dark-sm hover:shadow-soft-md dark:hover:shadow-soft-dark-md transition-shadow duration-300 ease-soft-out">
